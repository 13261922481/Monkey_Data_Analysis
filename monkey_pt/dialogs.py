...
def addButton(frame, name, callback, img=None, tooltip=None,
              side=TOP, compound=None, width=None, padding=None, padd_x=None):
    ...
    b.image = img
    b.pack(side=side,fill=X,padx=padd_x,pady=padding)
    if tooltip != None:
...
class AggregateDialog(BaseDialog):
    ...
    def __init__(self, parent=None, df=None, notebook=None):
    ...
    def apply(self):
        ...
        self.parent.createChildTable(self.result, 'aggregated', index=True, out=False, notebook=self.notebook)
        #self.quit()
        return
